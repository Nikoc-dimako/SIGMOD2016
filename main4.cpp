...
#include <queue>
#include <pthread.h>
#include "threadpool11/blockingconcurrentqueue.h"
...
public:
  ...
  {
	  int q1smaller = ForwardG[nameChange[q1.a]].children > BackwardG[nameChange[q1.b]].children ? BackwardG[nameChange[q1.b]].children : ForwardG[nameChange[q1.a]].children;
	  int q2smaller = ForwardG[nameChange[q2.a]].children > BackwardG[nameChange[q2.b]].children ? BackwardG[nameChange[q2.b]].children : ForwardG[nameChange[q2.a]].children;
...
//moodycamel::BlockingConcurrentQueue<SP_Params> queries;
vector<SP_Params> queries;
...
void shortest_path(int thread_id) {
	...
	SP_Params q;
	Node tempa,tempb;
	int result,localVersion,resultsCounter;
	while(!work_done){
		...
		tempa=q.a;
		tempb=q.b;
		localVersion=q.versionCounter;
		resultsCounter=q.resultsCounter;
